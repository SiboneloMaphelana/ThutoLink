...
export const DashboardActions = createActionGroup({
  ...
  events: {
    ...
    'Create Assignment Requested': props<{ payload: { classId: string; title: string; description: string; dueDate: string } }>(),
    'Submit Assignment Requested': props<{ assignmentId: string; content: string }>(),
